...
- `/agent-auth:testing-agentkit-tools generate-link --connection-name MY_GMAIL --identifier user_123`
- `/agent-auth:testing-agentkit-tools execute-tool --tool-name gmail_fetch_mails --connection-name MY_GMAIL --identifier user_123 --tool-input '{"query":"is:unread","max_results":5}'`
