...
Prefer live tool discovery over hand-maintained catalogs. If the user needs the current tool list or schema, switch to `discovering-agentkit-tools` or `testing-agentkit-tools`.
