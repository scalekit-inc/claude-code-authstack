...
1. **FastMCP (Simplest)**
   ...
   - Skill: [adding-mcp-oauth](../skills/adding-mcp-oauth/SKILL.md)
...
2. **Express.js (Full Control)**
   ...
   - Skill: [adding-mcp-oauth: Express](../skills/adding-mcp-oauth/express-reference.md)
...
3. **FastAPI + FastMCP (Python)**
   ...
   - Skill: [adding-mcp-oauth: FastAPI](../skills/adding-mcp-oauth/fastapi-reference.md)
